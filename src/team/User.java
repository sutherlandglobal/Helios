...
public class User 
{
	...
	private HashMap<String, ArrayList<Object>> userObjects;
	...
	public User(String name)
	{
		...
		userObjects = new HashMap<String, ArrayList<Object>>();
	}
	...
	public boolean addAttr(String attr)
	{
		...
		{
			data.put(attr, new ArrayList<String>());
			retval = true;
		}
	 ...
	 */
	public ArrayList<String> getAttrData(String attr)
	{
	...
	public void addObject(String objectName, Object data)
	{
		...
		{
			userObjects.put(objectName, new ArrayList<Object>());
		}
	 ...
	 */
	public ArrayList<Object> getUserObjects(String objectName)
	{
