...
public class DateParser 
{
	...
	public static final int QUARTERLY_GRANULARITY = 5;
	 ...
	 */
	private String getQuarterGrain(GregorianCalendar date)
	{
		//YYYY-0Q
	...
	public String getDateGrain(int dateGrain, GregorianCalendar date)
	{
		...
		else if(dateGrain == MONTHLY_GRANULARITY )
		{
			retval = getMonthGrain(date);
		}
		else if(dateGrain == QUARTERLY_GRANULARITY )
		{
	...
	public static void main(String[] args) 
	{
		...
		System.out.println(d.getDateGrain(YEARLY_GRANULARITY, d.convertSQLDateToGregorian("2010-06-27 00:00:00")));
		
		System.out.println(d.getDateGrain(QUARTERLY_GRANULARITY, d.convertSQLDateToGregorian("2010-06-27 00:00:00")));
		System.out.println(d.getDateGrain(QUARTERLY_GRANULARITY, d.convertSQLDateToGregorian("2010-07-27 00:00:00")));
		System.out.println(d.getDateGrain(QUARTERLY_GRANULARITY, d.convertSQLDateToGregorian("2010-10-27 00:00:00")));
		System.out.println(d.getDateGrain(QUARTERLY_GRANULARITY, d.convertSQLDateToGregorian("2010-01-27 00:00:00")));
