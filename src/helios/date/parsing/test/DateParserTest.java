...
public class DateParserTest extends TestCase
{
	...
	{		
		...
		assertEquals("New years day 2011 day grainularity", "2011-01-01", TimeGrains.getDateGrain(TimeGrains.DAILY_GRANULARITY, testDate));

		//TIME STAMP:  1294697538
		//DATE: 01 / 10 / 11 @ 4:12:18pm EST
		epochTestDate = 1294697538;
		testDate.setTimeInMillis(epochTestDate*1000);
		assertEquals("Random day grain", "2011-01-10", TimeGrains.getDateGrain(TimeGrains.DAILY_GRANULARITY,testDate));

		//TIME STAMP:  1296511938
		//DATE: 01 / 31 / 11 @ 4:12:18pm EST
		epochTestDate = 1296511938;
		testDate.setTimeInMillis(epochTestDate*1000);
		assertEquals("2011-01-31", TimeGrains.getDateGrain(TimeGrains.DAILY_GRANULARITY,testDate));
