...
import helios.roster.test.MockRoster;
...
public class MockReport extends Report 
{
	...
	/* (non-Javadoc)
	 * @see helios.report.Report#setupDataSourceConnections()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see helios.report.Report#setupReport()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see helios.report.Report#setupLogger()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see helios.report.Report#runReport()
	 */
	@Override
		...
		for(String[] row : rawData)
		{
			...
			if(roster.getUser(userID) != null)
			{
				...
				if(isTimeTrendReport())
				{
					...
					reportGrain = TimeGrains.getDateGrain(timeGrain, DateParser.convertSQLDateToGregorian(timeStamp));
				}
