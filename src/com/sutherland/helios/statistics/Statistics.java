package com.sutherland.helios.statistics;
...
public final class Statistics 
{
	 ...
	 */
	public static double getTotal(ArrayList<String> dataSet)
	{
		double retval = 0.0;
	 ...
	 */
	public static double getAverage(ArrayList<String> dataSet)
	{
		Double retval = 0.0;
	 ...
	 */
	private static Vector<Double> convertToDouble(ArrayList<String> dataSet) throws NumberFormatException
	{
