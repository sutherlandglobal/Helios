package com.sutherland.helios.report.parameters;
...
import com.sutherland.helios.report.parameters.parameter.DateFormatParameter;
import com.sutherland.helios.report.parameters.parameter.EndDateParameter;
import com.sutherland.helios.report.parameters.parameter.NumDriversParameter;
...
import com.sutherland.helios.report.parameters.parameter.SourceParameter;
...
import com.sutherland.helios.report.parameters.parameter.UserGrainParameter;
...
public class ReportParameters
{
	...
	public ReportParameters() 
	{
		...
		parameters.put(ParameterInfo.DATE_FORMAT_PARAM, new DateFormatParameter());
		...
		supportedHTTPParameters.add(ParameterInfo.DATE_FORMAT_HTTP_PARAM_NAME);
	}
	...
	public boolean addParameter(String key, String value) 
	{
		...
		if(isValidParameter(key))
		{
			...
			else if(key.equals(ParameterInfo.DATE_FORMAT_PARAM) || key.equals(ParameterInfo.DATE_FORMAT_HTTP_PARAM_NAME))
			{
				retval = setDateFormat(Integer.parseInt(value));
			}
	...
	public String getDateFormat()
	{
		...
		try
		{
			retval = parameters.get(ParameterInfo.DATE_FORMAT_PARAM).getValues().get(0);
		}
		catch(Exception t)
		{}
	...
	public boolean setDateFormat(int dateFormat)
	{
		return setDateFormat("" + dateFormat);
	}
	
	public boolean setDateFormat(String dateFormat)
	{
		parameters.get(ParameterInfo.DATE_FORMAT_PARAM).clearValues();
		return parameters.get(ParameterInfo.DATE_FORMAT_PARAM).addValue(dateFormat);
	}
