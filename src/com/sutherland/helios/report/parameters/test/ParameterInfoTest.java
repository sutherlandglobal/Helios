...
public class ParameterInfoTest extends TestCase 
{
	...
	{
		assertEquals("Parameter count", 12, ParameterInfo.availableParameters.size());
		...
		assertTrue("Date Format parameter",ParameterInfo.availableParameters.contains(ParameterInfo.DATE_FORMAT_PARAM));
	}
