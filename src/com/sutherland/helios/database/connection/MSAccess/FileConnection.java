...
import com.sutherland.helios.exceptions.InvalidSyntaxException;
import com.sutherland.helios.util.IOLocker;
...
public class FileConnection extends DatabaseConnection
{
	 ...
	 *
	 * @see com.sutherland.helios.database.connection.DatabaseConnection#runParallelQueries(java.util.ArrayList)
	 */
