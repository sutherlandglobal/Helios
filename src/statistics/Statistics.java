...
public final class Statistics 
{
	 ...
	 */
	public double getTotal(ArrayList<String> dataSet)
	{
		double retval = 0.0;
	 ...
	 */
	public double getAverage(ArrayList<String> dataSet)
	{
		Double retval = 0.0;
	 ...
	 */
	private Vector<Double> convertToDouble(ArrayList<String> dataSet) throws NumberFormatException
	{
