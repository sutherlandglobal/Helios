...
<%@ page import="helios.constants.Constants"%>
...
<p>Any questions, updates, or priority revisions should be directed to me directly.</p>


<%
	File thisFile = new File(Constants.PLATFORM_DIR + "/webapps/Framework/objectives.jsp");
	
	GregorianCalendar modDate = new GregorianCalendar();
	modDate.setTimeInMillis(thisFile.lastModified());
	
	String modString = "" + modDate.get(Calendar.YEAR) + "-" + (1+modDate.get(Calendar.MONTH)) + "-" + modDate.get(Calendar.DAY_OF_MONTH) + " " + modDate.get(Calendar.HOUR_OF_DAY) + ":" + modDate.get(Calendar.MINUTE) + ":" + modDate.get(Calendar.SECOND);
%>
...
<ul>
	<br>
	<li>Implement and deploy program reports in their respective sites in the Helios Reporting Framework, using available data sources - <b>TOP PRIORITY</b></li>
	...
	<ul>
		<li>Implement JUNIT tests for reporting framework deployment, as well as Private Label reports.</li>
	</ul>
...
<h4>2014-05-04</h4>
<ul>
	<li>Began massive GIT checkin.</li>
</ul>

<h4>2014-04-27</h4>
<ul>
	<li>Production deployment.</li>
	<li>Fix network interface config issue on production.</li>
	<li>Refactored framework logging structure.</li>
</ul>

<h4>2014-04-20</h4>
<ul>
	<li>Patched a resource leak in logging.</li>
	<li>Removed all logging from Helios proper. Logging is handled by sites exclusively.</li>
	<li>Added site logo sub-banners to Helios sites.</li>
</ul>

<h4>2014-04-13</h4>
<ul>
	<li>Created two dummy helios sites to speed up refactoring tests.</li>
	<li>Added logging of report requests at the HTTP level with URL, user, ip, and origin.</li>
</ul>

<h4>2014-04-06</h4>
<ul>
	<li>Fixed X-axis label orientation in charts.</li>
	<li>Confirm absence of heartbleed vulnerabilities.</li>
</ul>

<h4>2014-03-30</h4>
<ul>
	<li>Implemented parameter groups, accessible to the UI. Each report now tells the UI exactly what it needs to execute.</li>
	<li>Added simple HTML header for HTML reports.</li>
</ul>
<h4>2014-03-23</h4>
<ul>
	<li>Forced UI to add all teams to report if no teams or users are selected.</li>
	<li>Patched reportprocessor to support querying a report's static information without any instantiation.</li>
	<li>Patched roster user querying to transfer less data</li>
	<li>Patched issue with graph series rejecting some date intervals.</li>
</ul>
<h4>2014-03-16</h4>
<ul>
	<li>Adding new Hughes reports: Realtime Sales Queue, Created Customer Volume, Call Volume, AOV, Sales Count, Realtime Sales, Conversion, RPC.</li>
	<li>Added new Private Label Report: Realtime Sales Queue.</li>
	<li>Patched several LMI reports to use Private Label roster.</li>
</ul>
<h4>2014-03-09</h4>
<ul>
	<li>Patched issues with multi-site log4j config.</li>
	<li>Refactored Private Label site into WAR-friendly structure.</li>
	<li>Implemented Realtime Sales queue report for Hughes.</li>
	<li>Added javadoc links for 3rd party libraries.</li>
	<li>Working Helios site WAR implementation.</li>
	<li>Working servlet implementation.</li>
	<li>Implemented reporting servlet to build and display images directly without explicitly writing to the file system.</li>
</ul>
<h4>2014-03-02</h4>
<ul>
	<li>Installed new sutherlandglobal.com certs</li>
	<li>Patched an issue with an invalid cert chan.</li>
	<li>Working Framework site in WAR form.</li>
	<li>Implemented better management and referencing of 3rd party libraries.</li>
</ul>
<h4>2014-02-23</h4>
<ul>
	<li>Implemented Call Volume for Hughes.</li>
	<li>PoC for building a WAR of a Helios site via Ant.</li>
	<li>Ported Sales reports from Private Label to Hughes.</li>
	<li>Implemented the Created Customer Volume report.</li>
</ul>
<h4>2013-11-03 - 2014-02-16</h4>
<ul>
	<li>UI redesign and overhaul.</li>
	<li>PoC of SSL support with self-signed certificate.</li>
	<li>PoC of authentication via HTTP BASIC.</li>
	<li>Built and deployed reports for Hughes.</li>
	<li>Gutted BIRT in favor of JFreeChart.</li>	
	<li>Implemented SSL for Helios sites using Sutherland's SSL cert.</li>
	<li>Greatly expanded JUnit testing.</li>
	<li>Simplified report types into basic archetypes.</li>
	<li>Implemented User Granularity for use with stack reports.</li>
	<il>Interfaced Roster and Team reports directly with the UI to streamline user interaction.</il>
	<li>Reports now accept multiple team and roster names.</li>
	<li>Broke down IVR/LMI CSAT/DSAT rate reports into subreports.</li>
	<li>Implemented resolution of LMI user to ezclm user</li>
	<li>Patched Private Label LMI reports to use the Private Label Roster.</li> 
	<li>Implemented the Created Customers queue for Hughes.</li>
	<li>Patched reports to supply schema information to front-ends and charting tools.</li>
	<li>Refactored custom objects for Surveys and Schedules outside of implementing sites.</li>
	<li>Framework-wide testing.</li>
	<li>Production deployment of new Framework functionality.</li>
</ul>

<h4>2013-11-03</h4>
<ul>
	<li>Created Hughes site.</li>
	<li>Deployed drop-in Hughes reports.</li>
	<li>Began reviewing Bomgar API documentation.</li>
	<li>Refactored all date parsing and arithmetic into Helios utilities.</li>
	<li>Fixed logging issue where database connections were logged before report was initiated.</li>
	<li>Refactored helios sites into site-unique package structure.</li>
</ul>
<h4>2013-10-27</h4>
<ul>
	<li>Began researching JQuery to simplify site ui management.</li>
	<li>Refactored API service to be site-specific.</li>
</ul>
<h4>2013-10-20</h4>
<ul>
	<li>Began extensive landing page redesign.</li>
	<li>Began research into authentication methods for tomee.</li>
</ul>
<h4>2013-10-13</h4>
<ul>
	<li>Added two vcpus to production.</li>
	<li>Created perl script to automate deployment of new Helios sites.</li>
</ul>
<h4>2013-10-06</h4>
<ul>
	<li>Added logging to API functionality.</li>
	<li>Force log directory creation upon build.</li>
	<li>Better error handling and parameter scrubbing in API front-end.</li>
	<li>Added dev and staging warning banners to UI.</li>
</ul>
<h4>2013-09-29</h4>
<ul>
